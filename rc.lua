...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "term", "www", "irc", "dev", "dev", "dev", "dev", "doc" }, s, { layouts[2], layouts[1], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[1] })
end
-- }}}
...
-- Create memory usage textbox
-- Initialize widget
memwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, "Mem: $1% ($2MB/$3MB)", 15)

-- Create CPU usage textbox
-- Initialize widget
cpuwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(cpuwidget, vicious.widgets.cpu, "CPU: $1%")

-- Create battery textbox
-- Initialize widget
powerwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(powerwidget, vicious.widgets.bat, "Pow: $2%", 120, "BAT0")
